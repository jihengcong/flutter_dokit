...
class DoKitHttpClient implements HttpClient {
  ...
  set connectionFactory(Future<ConnectionTask<Socket>> Function(Uri url, String? proxyHost, int? proxyPort)? f) {
    ...
    origin.connectionFactory = f as Future<ConnectionTask<Socket>> Function(Uri url, String? proxyHost, int? proxyPort)?;
  }

  @override
  set keyLog(Function(String line)? callback) {
    // TODO: implement keyLog
    origin.keyLog = callback as Function(String line)?;
  }
}
